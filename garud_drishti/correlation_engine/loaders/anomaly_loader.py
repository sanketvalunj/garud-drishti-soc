...
class AnomalyLoader:
    ...
    def __init__(
        ...
        file_path: str | Path = "garud_drishti/data/processed/anomaly_events.json",
        catalog_path: str | Path = "garud_drishti/correlation_engine/config/normalized_event_catalog.json",
