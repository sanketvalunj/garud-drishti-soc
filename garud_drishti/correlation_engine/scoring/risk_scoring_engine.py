...
class RiskScoringEngine:
    ...
    def __init__(
        self,
        config_path: str | Path = r"garud_drishti\correlation_engine\config\risk_config.json",
        entity_weights_path: str | Path = r"garud_drishti\correlation_engine\config\entity_weights.json",
    ) -> None:
